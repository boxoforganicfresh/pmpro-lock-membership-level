...
== Known Issue == REVISED
It is very important to create a new page for the "Membership Locked" message and assign it under Memberships > Page FIRST before attempting
to use or test this plugin.  Otherwise it will cause a loop on the site.  Doing this first will prevent this from happening and will fix this issue.
